    ...
    <div style={stockStyles.page}>
      ...
      <header style={stockStyles.header}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <button style={stockStyles.toolBtn} onClick={exportExcel} onMouseEnter={(e) => showTip2(e, "Exportar inventário para Excel")} onMouseLeave={hideTip2}>
            <IconFileSpreadsheet size={16} />
          </button>
          <button style={stockStyles.toolBtn} onClick={exportPDF} onMouseEnter={(e) => showTip2(e, "Imprimir / Guardar PDF do inventário")} onMouseLeave={hideTip2}>
            <IconPrinter size={16} />
          </button>
        </div>
      </header>
